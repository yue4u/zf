use crate::commands::{
    ...
    Fsays, Game, GameEnd, GameMenu, GameStart, GameTutorial, Hi, Level, LevelList, LevelNext,
    LevelRestart, LevelStart, Mission, MissionTargets, Mystery, Radar, Task, TaskRun, TaskStop,
    TermOpacity, Time, TimeScale, UI,
};
use anyhow::Result;
use nu_command::*;
